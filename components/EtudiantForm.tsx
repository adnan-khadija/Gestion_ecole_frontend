        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={handleChange}
              required
              className="w-full px-4 py-1 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8a8a19] focus:border-transparent transition-all"
            />
          </div>
          <div className="space-y-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              onChange={handleChange}
              required
              className="w-full px-4 text-sm py-1 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8a8a19] focus:border-transparent transition-all appearance-none bg-white bg-[url('data:image/svg+xml;base64,')] bg-no-repeat bg-[center_right_1rem]"
            >
